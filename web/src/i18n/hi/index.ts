export default {
  ...
  samplingMode: {
    ...
    edgeDetectMode: 'एज डिटेक्शन मोड',
    edgeDetectModeDesc: 'एज डिटेक्शन द्वारा पिक्सेल ग्रिड को स्वचालित रूप से पहचानता है, फाइन-ट्यूनिंग का समर्थन करता है',
  ...
  // एज डिटेक्शन मोड पैरामीटर
  edgeDetect: {
    title: 'एज डिटेक्शन पैरामीटर',
    edgeThreshold: 'एज थ्रेसहोल्ड',
    edgeThresholdDesc: 'कम मान अधिक किनारों का पता लगाते हैं, उच्च मान कम किनारों का पता लगाते हैं',
    minGridSize: 'न्यूनतम ग्रिड साइज़',
    minGridSizeDesc: 'पता लगाया गया न्यूनतम पिक्सेल ग्रिड साइज़',
    maxGridSize: 'अधिकतम ग्रिड साइज़',
    maxGridSizeDesc: 'पता लगाया गया अधिकतम पिक्सेल ग्रिड साइज़',
    manualPixelSize: 'मैनुअल पिक्सेल साइज़',
    manualPixelSizeDesc: 'ऑटो-डिटेक्शन के लिए 0 पर सेट करें, अन्यथा निर्धारित साइज़ का उपयोग करें',
    gridPosition: 'ग्रिड स्थिति फाइन-ट्यूनिंग',
    offsetX: 'क्षैतिज ऑफसेट (X)',
    offsetXDesc: 'ग्रिड की क्षैतिज स्थिति को फाइन-ट्यून करें, दशमलव स्टेप का समर्थन करता है',
    offsetY: 'ऊर्ध्वाधर ऑफसेट (Y)',
    offsetYDesc: 'ग्रिड की ऊर्ध्वाधर स्थिति को फाइन-ट्यून करें, दशमलव स्टेप का समर्थन करता है',
    showRealtimePreview: 'रीयल-टाइम प्रीव्यू दिखाएं (ग्रिड ओवरले)',
    showRealtimePreviewDesc: 'वास्तविक समय में मूल छवि पर पता लगाए गए ग्रिड लाइनों को प्रदर्शित करें',
    sampleSettings: 'सैंपलिंग सेटिंग्स',
    sampleMode: 'सैंपलिंग मोड',
    sampleModeDesc: 'प्रत्येक ग्रिड सेल के लिए सैंपलिंग विधि चुनें',
    weightRatio: 'वेट रेश्यो',
    weightRatioDesc: 'सैंपलिंग क्षेत्र के लिए वेट रेश्यो',
    useNativeRes: 'नेटिव रिज़ॉल्यूशन का उपयोग करें (1 पिक्सेल = 1 ग्रिड)',
    useNativeResDesc: 'प्रति ग्रिड सेल एक पिक्सेल आउटपुट करें, स्केलिंग नहीं',
    pixelSize: 'पिक्सेल साइज़',
    sampleGrid: 'सैंपल ग्रिड',
    gridPreview: 'ग्रिड प्रीव्यू (रीयल-टाइम)',
    pixelatedResult: 'पिक्सेलेटेड परिणाम',
